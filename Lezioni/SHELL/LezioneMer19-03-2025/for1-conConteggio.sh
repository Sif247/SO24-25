...
cont=0 	#variabile che serve per contare gli elementi trovati e con valore iniziale zero!
...
echo Il numero totale dei file o directory presenti nella dir corrente = $cont
