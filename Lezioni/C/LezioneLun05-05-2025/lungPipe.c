/* Programma in C lungPipe.c che non ha bisogno di parametri e mostra la dimensione limitata di una pipe */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
int main()
{
   ...
   char c = 'x'; 	/* non serviva inizializzare il valore del carattere che viene scritto sulla pipe, tanto nessuno lo legge */
	...
	{
		write(piped[1], &c, 1); /* scrittura sulla pipe di un singolo carattere alla volta */
