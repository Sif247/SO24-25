/* Programma in C provaPipe-SenzaClose.c che diversamente dal programma provaPipe.c NON chiude nel figlio il lato di lettura della pipe e nel padre il lato di scrittura */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <fcntl.h>
