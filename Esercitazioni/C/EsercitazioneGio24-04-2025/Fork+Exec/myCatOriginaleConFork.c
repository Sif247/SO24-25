/* Programma in C myCatOriginaleConFork.c che ha bisogno di un solo parametro e mostra l'uso della primitiva execlp per la esecuzione del comando cat da parte di un processo figlio (generato con fork e con il padre che attende la fine con wait) usando la ridirezione dello standard input dal parametro passato */
#include <stdio.h> 
#include <stdlib.h> 
#include <unistd.h>
#include <fcntl.h> 
