/* File padreFiglioConStatus.c che non ha bisogno di parametri e in cui il padre crea un processo figlio che deve generare un numero random (fra 0 e 99) e quindi lo torna al padre. Il padre deve stampare il valore ritornato dal figlio (sicuramente minore di 255 */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
