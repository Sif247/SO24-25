/* File sostituisciCar1.c che deve eseguire sul file (primo parametro) una sostituzione di tutte le occorrenze del carattere Cx (secondo parametro) con il carattere Change (terzo parametro) */
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <fcntl.h>
...
{   int fd;		/* variabile per open */
	...
	/* isoliamo il singolo carattere del secondo parametro: nome della variabile definito nel testo */
	Cx=argv[2][0];
	...
	/* isoliamo il singolo carattere del terzo parametro: nome della variabile definito nel testo */
	Change=argv[3][0];
