#!/bin/sh
#File comandi prova-variabili-bis.sh
...
export z		        #dato che abbiamo modificato z per compatibilita' facciamo di nuovo l'ezport, che pero' NON VALE INDIETRO, ma solo in AVANTI! 
